...
<template>
  <div class="welcome-area">
    ...
    <div class="welcome-subtitle">
      可以帮你创建和编辑图形、管理蓝图、生成思维导图，随时问我任何问题
    </div>
...
.suggestion-cards {
  ...
  .suggestion-card {
    ...
    .sg-icon { font-size: 22px; margin-bottom: 6px; }
    .sg-label { font-size: 14px; font-weight: 600; color: $text; margin-bottom: 2px; }
    .sg-desc { font-size: 12px; color: $text-muted; }
  }
}
</style>
